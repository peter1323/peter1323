...
<p align="left"># 🌐🧑‍💻Desarrollador y entusiasta de la tecnología  <br><br>🎓 Titulado en <b>Técnico Superior en Desarrollo de Aplicaciones Multiplataforma (DAM)</b> y <b>Administración de Sistemas Informáticos en Red (ASIR)</b>.  <br><br>🚀 En este perfil encontrarás proyectos que reflejan lo aprendido durante mis estudios y mi pasión por el desarrollo de software.  <br><br>🛠️ <b>Lenguajes y herramientas con los que trabajo:</b>  <br>- <b>Lenguajes de programación:</b> Java ☕, JavaScript 🟨, Python 🐍, PHP 🐘, C y C++ 🔵  <br>- <b>Desarrollo web:</b> HTML5, CSS3 🛠️  <br>- <b>Aplicaciones móviles:</b> Android 🤖  <br>- <b>IDE y editores:</b> Visual Studio Code🔷, IntelliJ IDEA💡 , Android Studio🤖<br>- <b>Sistemas operativos:</b> Linux 🐧, Windows 🪟 <br>- <b>Contenedores y orquestación:</b> Docker 🐳, Kubernetes☸️ <br>- <b>Bases de datos:</b> MySQL 🐬, SQLite, MongoDB 🍃  <br>- <b>Control de versiones y diseño:</b> Git🌱, Figma 🎨  <br>- <b>Otras herramientas:</b> Grafana 📊, Jira 📋  <br><br>💼 Siempre aprendiendo y explorando nuevas tecnologías.  <br><br>¡Espero que encuentres algo interesante por aquí! 🚀</p>
